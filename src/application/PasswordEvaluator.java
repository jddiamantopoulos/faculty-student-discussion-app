...
public class PasswordEvaluator {
	 ...
	 * 
	 * @author Lynn Robert Carter, Eli Sells (Student Submission)
	 * 
...
>>>>>>> TP1-HS
		...
		String errMessage = "";
		if (!foundUpperCase)
			errMessage += "At least one upper case character; ";
		
		if (!foundLowerCase)
			errMessage += "At least one lower case character; ";
		
		if (!foundNumericDigit)
			errMessage += "At least one number; ";
			
		if (!foundSpecialChar)
			errMessage += "At least one special character; ";
			
		if (!foundLongEnough)
			errMessage += "At least eight characters; ";

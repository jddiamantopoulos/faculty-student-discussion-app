...
public class UsernameRecognitionTestingAutomation {
	...
	public static void main(String[] args) {
		...
		// Starts with number
		performTestCase(1, "1aDb", false);
		// Insufficient length
		performTestCase(2, "a1a", false);
		// Subsequent special characters
		performTestCase(3, "a..ad", false);
		// Too long
		performTestCase(4, "abcde3f.sdhWoohooThisIsFun", false);
		// Invalid character present
		performTestCase(5, "ab$ds\nr", false);
		
		// Testing some valid names
		performTestCase(6, "Username", true);
		performTestCase(7, "UserNumber_5", true);
		performTestCase(8, "e8ightysix", true);

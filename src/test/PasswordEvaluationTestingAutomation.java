...
public class PasswordEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		// Length insufficient
		performTestCase(1, "bG3#", false);
		// No numbers present
		performTestCase(2, "bG#shdus", false);
		// No lowercase present
		performTestCase(3, "55#GHSDEU", false);
		// No uppercase present
		performTestCase(4, "abcde3$sdh", false);
		// No special chars present
		performTestCase(5, "abcde3Ssdh", false);
		// Invalid character present
		performTestCase(6, "abcde3S\n#sdh", false);
		
		// Testing some valid passwords
		performTestCase(7, "Pas$W0rd", true);
		performTestCase(8, "abCd3FGHIJK#", true);
		performTestCase(9, "husd8&Dd", true);

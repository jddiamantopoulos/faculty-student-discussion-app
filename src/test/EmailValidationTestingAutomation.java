...
/*******
 * <p> Title: EmailValidationTestingAutomation Class. </p>
 * 
 * <p> Description: Repurposed the PasswordEvaluator module tests (again) </p>
 * 
 ...
 * 							   Monday25 submission.
 * @version 2.20	2025-02-04 Updated for UsernameRecognizer class.
 * @version 2.30	2025-02-06 Updated for EmailValidator class.
 * 
 */
public class EmailValidationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(1, "ets\\ells@asu.edu", false);
		// Invalid char in SLD
	...
	private static void performTestCase(int testCase, String inputText, boolean expectedPass) {
		...
		String resultText= EmailValidator.validateEmail(inputText);
